...
const timeline = [
    {
        ...
        org: 'HackerRank',
        period: 'Earned Aug 2026',
        detail: 'Demonstrated proficiency in core software engineering fundamentals, problem-solving, and algorithmic skills by passing the official HackerRank role certification assessment (ID: 805C05BB33A8).'
    },
    {
        type: 'Experience',
        icon: BriefcaseBusiness,
        title: 'Big Data & Business Management Intern',
        org: 'IBM SkillsBuild & AICTE',
        period: 'Jun 2026 – Jul 2026',
        detail: 'Built practical foundations in data-driven business analysis and large-scale data concepts through guided, industry-aligned learning.'
    },
    {
        type: 'Certification',
        icon: Award,
        ...
        period: 'Earned Jul 2026',
        detail: 'Mastered foundational concepts of Generative AI, Large Language Models (LLMs), deep learning architecture, and responsible AI principles using Google Cloud technologies.'
    },
    {
        type: 'Certification',
        icon: Award,
        title: 'Samsung AI Certification',
        org: 'Samsung Innovation Campus',
        period: 'Dec 2025 – Mar 2026',
        detail: 'Completed structured training in artificial intelligence concepts and their practical applications.'
    },
    {
        type: 'Certification',
        icon: Award,
        title: 'Introduction to Generative AI',
        org: 'Google Cloud / Coursera',
        period: 'Credential earned',
        detail: 'Explored core generative AI concepts, use cases, and responsible implementation practices.'
